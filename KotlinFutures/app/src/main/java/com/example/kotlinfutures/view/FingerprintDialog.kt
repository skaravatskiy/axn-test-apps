...
class FingerprintDialog : DialogFragment(), Callback {
    ...
    override fun onResume() {
        ...
        helper.cryptoInstance()?.let {
            helper.startListening(it)
        }
    }
    ...
    companion object {
        ...
        private val successDialog =
            FingerDialog("Succeeded", R.drawable.ic_fingerprint, R.color.green)
        private val defaultDialog = FingerDialog(
            "Touch your sensor",
